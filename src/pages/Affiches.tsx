    ...
    <div className="bg-gray-50 min-h-screen w-full max-w-full overflow-x-hidden">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-2 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white bg-[#6F73F3] rounded-md hover:bg-[#5F64EE] flex items-center space-x-1 sm:space-x-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-b border-gray-200 bg-white px-2 sm:px-6 py-3">
        <div className="flex items-center space-x-6">
          <span className="text-sm font-medium text-[#6F73F3] border-b-2 border-[#6F73F3] pb-1">
