        ...
        <div className="container mx-auto px-4 h-full flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-1">
            <div className="flex items-center">
              <span className="text-2xl font-extrabold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">DLC</span>
              <span className="ml-1 text-lg font-light tracking-widest text-gray-600 uppercase">Watcher</span>
              <svg className="w-5 h-5 ml-1 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
